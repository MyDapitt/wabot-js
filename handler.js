   ...
   async participantsUpdate({ id, participants, action }) {
		...
		case 'invite_v4':
			    ...
			    mentionedJid: [user],
                            ...
                            body: global.wm,
                            thumbnailUrl: pp,
                            sourceUrl: 'https://chat.whatsapp.com/channel/000',
                            mediaType: 1,
...
global.dfail = (type, m, conn) => {
    let msg = {
        rowner: 'Kamu siapa?',
        owner: 'Cuma ownerku yang bisa akses..',
        mods: 'Kamu bukan moderatorku :/',
        premium: 'Kamu bukan member premium.',
        group: 'Pakai fitur ini di grup.',
        private: 'Pakai ini di chat pribadi.',
        admin: 'Kamu bukan admin grup ini..',
        botAdmin: 'Jadiin aku admin dong biar bisa..',
